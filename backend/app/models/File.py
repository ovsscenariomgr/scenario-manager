...
class MediaFile(models.Model):
    ...
    filename = models.FileField(upload_to='media', storage=OverwriteStorage(), default='media/logo.jpeg')
...
class VocalFile(models.Model):
    ...
    filename = models.FileField(upload_to='vocals', storage=OverwriteStorage(), default='vocals/purr.wav')

# Generated by Django 4.2.10 on 2024-03-09 07:23
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('test', models.CharField(blank=True, choices=[('eq', 'Eq'), ('gt', 'Gt'), ('lt', 'Lt'), ('lte', 'Lte'), ('gte', 'Gte'), ('inside', 'Inside'), ('outside', 'Outside'), ('', 'None')], default='', max_length=7)),
                ('cpr_duration', models.IntegerField(default=None, null=True, validators=[django.core.validators.MinValueValidator(0)])),

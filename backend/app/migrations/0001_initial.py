# Generated by Django 4.2.23 on 2026-09-13 16:54
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('left_lung_sound', models.CharField(choices=[('normal', 'Normal'), ('coarse_crackles', 'Coarse Crackles'), ('fine_crackles', 'Fine Crackles'), ('wheezes', 'Wheezes'), ('stridor', 'Stridor'), ('stertor', 'Stertor'), ('same_as_right', 'Same As Right'), ('same_as_left', 'Same As Left')], default='normal', max_length=16, validators=[app.validators.validate_left_lung_sound])),
                ...
                ('right_lung_sound', models.CharField(choices=[('normal', 'Normal'), ('coarse_crackles', 'Coarse Crackles'), ('fine_crackles', 'Fine Crackles'), ('wheezes', 'Wheezes'), ('stridor', 'Stridor'), ('stertor', 'Stertor'), ('same_as_right', 'Same As Right'), ('same_as_left', 'Same As Left')], default='normal', max_length=16, validators=[app.validators.validate_right_lung_sound])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('filename', models.FileField(storage=app.storage.OverwriteStorage(), upload_to=app.storage.vocals_upload_to, validators=[app.validators.validate_wav_extension])),
                ('title', models.CharField(default='Purr', max_length=256)),
                ('scenario', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='vocalfiles', to='app.scenario')),
            ],
        ),
        migrations.CreateModel(
            name='Trigger',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('symptoms', models.TextField(blank=True, default='Scenario Symptoms')),
                ('image', models.ImageField(blank=True, null=True, storage=app.storage.OverwriteStorage(), upload_to=app.storage.image_upload_to)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('record', models.IntegerField(choices=[(0, 'Off'), (1, 'On')], default=0)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('filename', models.FileField(storage=app.storage.OverwriteStorage(), upload_to=app.storage.media_upload_to)),
                ('title', models.CharField(default='Logo', max_length=256)),
                ('scenario', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='mediafiles', to='app.scenario')),
            ],
        ),
        migrations.AddField(
            model_name='header',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('scenario', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='eventgroups', to='app.scenario')),
            ],
        ),
        migrations.CreateModel(
            name='Event',
            fields=[
                ...
                ('eventgroup', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='events', to='app.eventgroup')),
            ],
        ),
        migrations.CreateModel(
            name='Control',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('filename', models.ImageField(blank=True, null=True, storage=app.storage.OverwriteStorage(), upload_to=app.storage.image_upload_to)),
